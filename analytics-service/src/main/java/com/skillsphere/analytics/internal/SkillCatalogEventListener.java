 ...
 *
 * <p>{@code containerFactory} is explicit here — see
 * {@link SkillCatalogKafkaConfig}'s class comment for why this service
 * needs a second consumer factory rather than the one {@link
 * ResponseEventListener} uses.
 */
@Slf4j
@Component
...
public class SkillCatalogEventListener {
    ...
    @KafkaListener(topics = "skill-catalog-events", groupId = "analytics-service",
            containerFactory = "skillCatalogListenerContainerFactory")
