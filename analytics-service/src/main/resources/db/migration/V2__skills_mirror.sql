...
--
-- Same table, same reasoning as verification-service's and content-
-- service's own V2 — SkillNameLookup#nameOf used to query the shared
-- skills table directly, and now reads this local copy instead, kept
-- current by SkillCatalogEventListener. Only name is actually read here,
-- but the mirror carries the same columns as every other copy so it stays
-- interchangeable.
-- =============================================================================
