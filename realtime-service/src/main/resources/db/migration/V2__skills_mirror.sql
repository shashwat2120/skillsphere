...
--
-- Same table, same reasoning as verification-service's own V2 —
-- SkillLookupShim#findById (ArenaService, ConfusionDetectionService, both
-- resolving a skill name for display) used to query the shared skills
