...
--
-- Same table, same reasoning as verification-service's own V2 — this
-- service's SkillRef (findById, findAllActive; see CourseService) used to
-- query the shared skills table directly, and now reads this local copy
-- instead, kept current by SkillCatalogEventListener.
-- =============================================================================
